...
const typeMap: any = {
    "Stats": o([
        { json: "favouriteTargetCurrency", js: "favouriteTargetCurrency", typ: "" },
        { json: "totalConversionRequests", js: "totalConversionRequests", typ: 0 },
        { json: "totalUsdConverted", js: "totalUsdConverted", typ: 3.14 },
    ], "any"),
};
